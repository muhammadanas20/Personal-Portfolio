...
const projects = [
  ...
  },
  {
    ...
    category: "semester",
    description:
      "A C++ command-line simulation based on Object-Oriented Programming (OOP) that analyzes digital images for authenticity. Implements specialized heuristic analysis engines (Metadata, Artifacts, Frequency, Watermark, and Hybrid Deep) to generate detection confidence scores and verdicts.",
  ...
  },
  {
    ...
    description:
      "A WhatsApp-integrated AI assistant that generates complete, formatted course study documents from user queries. Employs a local RAG backend to ingest and manage academic resources for source citations, with fallback web search and AI generation when local resources are missing.",
    image: "/projects/rag_wa_ai.jpg",
    tags: ["Python", "RAG", "WhatsApp API", "Vector DB", "Web Search"],
  ...
  },
  {
    ...
    category: "ai-automation",
    description:
      "An AI WhatsApp bot for group chats that processes images sent with a 'quiz' caption. Automatically provides accurate answers directly in the chat, accompanied by step-by-step logical reasoning to verify the solution's correctness.",
    image: "/projects/quiz_wa_bot.jpg",
    tags: ["Node.js", "WhatsApp API", "Vision LLM", "AI Reasoning"],
  ...
  },
  {
    ...
    category: "ai-automation",
    description:
      "An academic automation bot that accepts assignment sheets, lab tasks, or problems students need to solve, uses advanced AI models to generate step-by-step solutions, and delivers the results directly to the user's provided email to save study time.",
    image: "/projects/gcr_assignment_bot.jpg",
    tags: ["Python", "GenAI APIs", "Gmail API", "Automation"],
