    ...
    <section id="education" className="py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mb-16">
          ...
          >
           A timeline of my academic growth, from building discipline at Bahria College to mastering computer science fundamentals at FAST NUCES.
          </p>
        </div>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <p className="text-muted-foreground">{exp.college}</p>
